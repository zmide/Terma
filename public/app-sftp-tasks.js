...
function renderSftpJob(job) {
  ...
  const transferWarning = job.warning ? `<div class="sftp-job-warning"><strong>传输提示</strong><span>${esc(job.warning).slice(0,500)}</span></div>` : "";
