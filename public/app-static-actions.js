...
registerTermaAction("static-connection-save-connect", ({element}) => saveConnectionForm(false, element, true, element.dataset.closeAfterSave === "1"));
...
registerTermaAction("static-config-selection-export", () => exportConfigSelectionUi());
registerTermaAction("static-config-selection-import", () => importConfigSelectionUi());
