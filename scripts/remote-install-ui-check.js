...
assert.match(remote, /watchVncClipboardHelperTask\(session, result\.task\.id, action\)/);
assert.match(remote, /watchVncClipboardHelperTask\(session, result\.task\.id, "uninstall"\)/);
...
assert.match(remote, /remoteComponentTaskContainer\(options\.scope, container\)/);
