...
const macosSession = parseBuiltinX11ProbeOutput([
  "TD_X11_DISPLAY=localhost:10.0",
  "TD_X11_XAUTH=/opt/X11/bin/xauth"
].join("\n"));
...
const detected = parseDetectionOutput([
  "TD_SSH_X11_PLATFORM=Darwin",
  "TD_SSH_X11_SSHD_PRESENT=1",
  "TD_SSH_X11_SSHD_PATH=/usr/sbin/sshd",
  "TD_SSH_X11_CONFIG_FILE=/etc/ssh/sshd_config",
  "TD_SSH_X11_CONFIG_PRESENT=1",
  "TD_SSH_X11_X11_FORWARDING=yes",
  "TD_SSH_X11_X11_USE_LOCALHOST=yes",
  "TD_SSH_X11_X11_DISPLAY_OFFSET=10",
  "TD_SSH_X11_XAUTH_PATH=/opt/X11/bin/xauth",
  "TD_SSH_X11_XAUTH_LOCATION=/opt/X11/bin/xauth",
  "TD_SSH_X11_XAUTH_LOCATION_VALID=1",
  "TD_SSH_X11_XQUARTZ_INSTALLED=1",
  "TD_SSH_X11_CAN_MANAGE=1",
  "TD_SSH_X11_CAN_TERMINAL_MANAGE=1"
].join("\n"));
