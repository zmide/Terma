...
async function main() {
  ...
  ok("模态弹窗不会因点击外部遮罩而误关闭", !frontend.includes("event.target === modal") && !frontend.includes("event.target===modal"));
