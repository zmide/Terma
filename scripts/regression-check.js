...
async function main() {
  ...
  ok("终端支持 Ctrl 加滚轮调整字号", terminalFrontend.includes("enableTerminalFontWheel") && terminalFrontend.includes("event.ctrlKey") && terminalFrontend.includes("event.stopPropagation()") && terminalFrontend.includes("{passive:false,capture:true}") && terminalFrontend.includes("changeTerminalFont(key, event.deltaY < 0 ? 1 : -1)"));
