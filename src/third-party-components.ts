...
const THIRD_PARTY_COMPONENTS:ThirdPartyComponent[] = [
  ...
  {name:"jsPDF", version:"4.2.1", license:"MIT", project_url:"https://github.com/parallax/jsPDF", use:"browser_pdf_generation"},
  {name:"svg2pdf.js", version:"2.8.1", license:"MIT", project_url:"https://github.com/yWorks/svg2pdf.js", use:"svg_vector_pdf_export"},
  {name:"Noto Sans SC", version:"2.004", license:"OFL-1.1", project_url:"https://github.com/notofonts/noto-cjk", use:"svg_pdf_cjk_font"},
  ...
  {name:"i18next", version:"26.4.2", license:"MIT", project_url:"https://github.com/i18next/i18next", use:"interface_i18n"},
  {name:"Lucide", version:"1.35.0", license:"ISC", project_url:"https://lucide.dev", use:"interface_icons"},
  {name:"Electron", version:"44.0.0", license:"MIT", project_url:"https://github.com/electron/electron", use:"desktop_runtime"},
