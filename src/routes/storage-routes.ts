...
export async function handleStorageRoutes(
  ...
  if (method === "PUT" && pathname === "/api/runtime-settings") {
    ...
    const next = dependencies.normalizeRuntimeSettings({
      ...
      ui_refresh_interval_ms:data.ui_refresh_interval_ms ?? current.ui_refresh_interval_ms,
      sftp_active_status_poll_interval_ms:data.sftp_active_status_poll_interval_ms ?? current.sftp_active_status_poll_interval_ms,
      sftp_background_status_poll_interval_ms:data.sftp_background_status_poll_interval_ms ?? current.sftp_background_status_poll_interval_ms,
      vnc_local_image_poll_interval_ms:data.vnc_local_image_poll_interval_ms ?? current.vnc_local_image_poll_interval_ms,
      vnc_remote_image_poll_interval_ms:data.vnc_remote_image_poll_interval_ms ?? current.vnc_remote_image_poll_interval_ms,
      ...
      desktop_notifications_enabled:data.desktop_notifications_enabled ?? current.desktop_notifications_enabled,
