...
> This release adds a central forwarding workspace with responsive card layouts, makes forwarding rules searchable and controllable from both Quick Open surfaces, and gives local forwarding links and SFTP text files more flexible formatting options.
...
> 本次更新新增采用自适应卡片布局的全局转发工作区，让两套“快速打开”都能搜索并控制转发，同时为本地转发链接和 SFTP 文本文件提供更灵活的格式设置。
